...
namespace Matrices.DLL
{
        ...
        where T : IComparable<T>
    {
        ...
        public static SquareMatrix<T> Addition(SquareMatrix<T> matrixA, DiagonalMatrix<T> matrixB)
        {
            ...
            SquareMatrix<T> newMatrix = new SquareMatrix<T>(matrixA.Size);
            for (int i = 0; i < matrixA.Size; i++)
            {
                for (int j = 0; j < matrixA.Size; j++)
                {
        ...
        public static DiagonalMatrix<T> Addition(DiagonalMatrix<T> matrixA, SquareMatrix<T> matrixB)
        {
            if (matrixA is null)
            {
                throw new ArgumentNullException(nameof(matrixA));
        ...
        public static DiagonalMatrix<T> Addition(DiagonalMatrix<T> matrixA, SymmetricalMatrix<T> matrixB)
        {
            if (matrixA is null)
            {
                throw new ArgumentNullException(nameof(matrixA));
        ...
        public static SymmetricalMatrix<T> Addition(SymmetricalMatrix<T> matrixA, SquareMatrix<T> matrixB)
        {
            if (matrixA is null)
            {
                throw new ArgumentNullException(nameof(matrixA));
