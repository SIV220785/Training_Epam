...
namespace Bank.DLL.Entities
{
    ...
    /// GoldAccount.
    /// </summary>
    public class PlattinumAccount : IAccount
    {
        private int id;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlattinumAccount"/> class.
        /// </summary>
        public PlattinumAccount()
        {
            this.bonusPoints = 0;
            this.client = new UserInfo();
            this.TypeAccount = "PlattinumAccount";
        }
        ...
        public void ReplenishmentBonuses(decimal amount)
        {
            ...
            else if (this.amount >= 1000)
            {
                ...
                {
                    this.bonusPoints += amount * 0.006M;
                }
                else if (amount >= 3000)
                {
                    this.bonusPoints += amount * 0.007M;
                }
            }
        }
