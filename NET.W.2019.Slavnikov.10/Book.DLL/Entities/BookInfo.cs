    ...
    public class BookInfo : IComparable, IComparable<BookInfo>, IEquatable<BookInfo>, IFormattable
    {
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            return format switch
            {
                ...
                "4" => $"ISBN: {this.ISBN}, Book: {this.BookTitle}, Author: {this.Author}, Publishing: {this.Publishing}," +
                           $" The year of publishing: {this.YearPublishing.Value}.",
                "5" => $"ISBN: {this.ISBN}, Book: {this.BookTitle}, Author: {this.Author}, Publishing: {this.Publishing}," +
                           $" The year of publishing: {this.YearPublishing.Value}," +
                           $" The number of pages: {this.NumberOfPages}.",
                "6" => $"ISBN: {this.ISBN}, Book: {this.BookTitle}, Author: {this.Author}, Publishing: {this.Publishing}," +
                           $" The year of publishing: {this.YearPublishing.Value}," +
                           $" The number of pages: {this.NumberOfPages}, Price: {this.Price}.",
